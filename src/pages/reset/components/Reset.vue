  ...
  data () {
    return {
      ...
      entArr: [
        ...
        {name: '密码1', code: '', value: '', placeHolder: '请输入您的密码', type: 'password', popType: '', fieldName: 'Password1', required: true, clearable: false, rightIcon: 'eye'},
        {name: '密码2', code: '', value: '', placeHolder: '再次确认您的密码', type: 'password', popType: '', fieldName: 'Password2', required: true, clearable: false, rightIcon: 'eye'},
      ...
      normalArr: [
        {name: '手机号码', code: '', value: '', placeHolder: '请输入您的手机号码', type: 'number', popType: '', fieldName: 'Mobile', required: true, clearable: true},
        {name: '密码1', code: '', value: '', placeHolder: '请输入您的密码', type: 'password', popType: '', fieldName: 'Password1', required: true, clearable: true, rightIcon: 'eye'},
        {name: '密码2', code: '', value: '', placeHolder: '再次确认您的密码', type: 'password', popType: '', fieldName: 'Password2', required: true, clearable: true, rightIcon: 'eye'},
        {name: '验证码', code: '', value: '', placeHolder: '请输入验证码', type: 'text', popType: '', fieldName: 'Code', isCode: true, required: true, clearable: true, isActiveBtn: false}
