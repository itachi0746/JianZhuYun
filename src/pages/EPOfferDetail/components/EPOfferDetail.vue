            ...
            <van-col span="5">
              <div class="data-box-r">
                <div class="data-head">
                  ...
                  <UserHead :theUrl="resData.RE32_PIC_URL" :theId="resData.RE32_CANDIDATE_ID"></UserHead>
                </div>
...
//    debugger
    ...
    postData('/EntService/OfferDetials', data).then((res) => {
      ...
      this.resData.RE32_CHG_TIME = myModule.handleTime(res.ReturnData.RE32_CHG_TIME)
    })
  },
